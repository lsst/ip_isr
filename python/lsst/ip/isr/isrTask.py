...
class IsrTaskConnections(pipeBase.PipelineTaskConnections,
    ...
    # DM-15257
    # fringe = cT.PrerequisiteInput(
    #     name="fringe",
    #     doc="Input fringe calibration frames.",
    #     storageClass="MaskedImageF",
    #     dimensions=["instrument", "physical_filter", "calibration_label", "detector"],
    # )
    ...
    def __init__(self, *, config=None):
        ...
        if config.doWrite is not True:
            self.outputs -= set(("outputExposure",))
            self.outputs -= set(("preInterpExposure",))
            self.outputs -= set(("outputFlattenedThumbnail",))
            self.outputs -= set(("outputOssThumbnail",))

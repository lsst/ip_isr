"""
@brief A simple test for the ISR stage, 'Fringe Correction'.
...
inMasterFilePath = os.path.join(dataDir, "CFHT", "D4", "05Am05.fringe.0.36.00_1")
isrPolicyPath = os.path.join(isrDir, "pipeline", "isrPolicy.paf")

## OUTPUT IMAGE AND PATH NAMES

outputPath = os.path.join(dataDir, "testFringeCorExposure")
...
class isrTestCases(unittest.TestCase):
    ...
    def testBiasCorrection(self):
        ...
        ipIsrFringe.fringeCorrection(self.chunkExposure, self.masterChunkExposure, self.isrPolicy)

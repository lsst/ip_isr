...
lsst::afw::image::Exposure<ImageT, MaskT> overscanCorrectAndTrimChunkExposure(
    ...
    std::string subStage = "Overscan Correct and Trim Chunk Exposure";
    ...
    lsst::pex::policy::Policy::Ptr overscanPolicy = isrPolicy.getPolicy("overscanPolicy");
    //std::string function;
    ...
    std::string ccdType;
    if (ccdTypeProp) {
        ccdType = boost::any_cast<std::string>(ccdTypeProp->getValue());
    } else {
    ...
    std::string datasec = boost::any_cast<std::string>(datasecProp->getValue());
    lsst::daf::base::DataProperty::PtrType biassecProp = chunkMetadata->findUnique("BIASSEC");
    std::string biassec = boost::any_cast<std::string>(biassecProp->getValue());
    lsst::daf::base::DataProperty::PtrType trimsecProp = chunkMetadata->findUnique("TRIMSEC");  
    std::string trimsec = boost::any_cast<std::string>(trimsecProp->getValue());
    ...
    chunkMetadata->addProperty(lsst::daf::base::DataProperty("DATASEC"));
    lsst::daf::base::DataProperty::PtrType newDatasecProp = chunkMetadata->findUnique("DATASEC");
    newDatasecProp->setValue(boost::any_cast<std::string>(trimsec));
    ...
    if (method == "function"){
        ...
        if (funcForm == "polynomial") {
            ...
            //lsst::afw::math::Function1<double> function1(funcOrder);
            ...
            trimmedChunkMetadata->addProperty(lsst::daf::base::DataProperty("ISR_OVERSCAN_FUNCTION"));
            lsst::daf::base::DataProperty::PtrType isrFuncProp = chunkMetadata->findUnique("ISR_OVERSCAN_FUNCTION");
            isrFuncProp->setValue(boost::any_cast<std::string>(funcForm));
            trimmedChunkMetadata->addProperty(lsst::daf::base::DataProperty("ISR_OVERSCAN_ORDER"));
            lsst::daf::base::DataProperty::PtrType isrOrderProp = chunkMetadata->findUnique("ISR_OVERSCAN_ORDER");
            isrOrderProp->setValue(boost::any_cast<const int>(funcOrder));
        ...
        if (constantMeth == "mean") {
            ...
            // Record the provenance
            trimmedChunkMetadata->addProperty(lsst::daf::base::DataProperty("ISR_OVERSCAN_MEAN"));
            lsst::daf::base::DataProperty::PtrType isrMeanProp = chunkMetadata->findUnique("ISR_OVERSCAN_MEAN");
            isrMeanProp->setValue(boost::any_cast<const double>(mu));
            trimmedChunkMetadata->addProperty(lsst::daf::base::DataProperty("ISR_OVERSCAN_STDEV"));
            lsst::daf::base::DataProperty::PtrType isrSigmaProp = chunkMetadata->findUnique("ISR_OVERSCAN_STDEV");
            isrSigmaProp->setValue(boost::any_cast<const double>(sigma));
            trimmedChunkMaskedImage.setMetadata(trimmedChunkMetadata);    
    ...
    trimmedChunkMetadata->addProperty(lsst::daf::base::DataProperty("ISR_OVERSCAN"));
    lsst::daf::base::DataProperty::PtrType overCorProp = chunkMetadata->findUnique("ISR_OVERSCAN");
    std::string exitTrue= "Completed Successfully";
    overCorProp->setValue(boost::any_cast<std::string>(exitTrue));
    trimmedChunkMetadata->addProperty(lsst::daf::base::DataProperty("ISR_OVERSCAN_END"));
    trimmedChunkMaskedImage.setMetadata(trimmedChunkMetadata);
